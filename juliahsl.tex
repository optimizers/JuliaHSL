...
\GDpostpubcitation{A. Montoison, J. Fowkes, A. Lister, D. Orban (2023). ``Un exemple de citation'', \emph{Journal of Journals}, vol. X issue Y, p. n-m}{https://www.gerad.ca/fr}
...
\paragraph{Keywords: }
Julia, numerical linear algebra, sparse
\end{GDabstract}
