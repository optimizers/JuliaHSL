...
\newcommand{\JuliaHSL}{JuliaHSL\xspace}  % Useful if we rename JuliaHSL
...
\GDtitre{\texttt{\JuliaHSL}: the ultimate collection for large-scale scientific computation}
\GDmois{Juin}{June}
\GDannee{2023}
\GDnumero{XX}
...
\href{https://licences.stfc.ac.uk/product/julia-hsl}{\JuliaHSL} is a collection of 155 HSL packages.
...
Additionally, \JuliaHSL supports either METIS 5 or the older METIS 4 \citep{karypis-kumar-1997}.
